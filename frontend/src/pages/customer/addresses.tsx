...
import { Alert, Badge, Button, Card, EmptyState, Field, Input, LoadingScreen, SectionHeader } from '../../components/ui';
...
export function AddressManagementPage(): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      ...
      {message ? <Alert tone="success" title="Address updated">{message}</Alert> : null}
      {error ? <Alert tone="danger" title="Address error">{error}</Alert> : null}
      ...
      <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
                ...
                <Card key={address.id} className="space-y-4 p-4">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {!address.is_default ? (
                        <Button variant="secondary" className="px-3 py-2" onClick={() => void handleSetDefault(address.id)}>
        ...
        <Card className="space-y-5 p-6">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <Field label="Address line 1" htmlFor="address-line-1" error={submitted ? validationErrors.address_line_1 : null} required>
              <Input
                id="address-line-1"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field label="Postal code" htmlFor="address-postal" error={submitted ? validationErrors.postal_code : null} required>
                <Input
                  id="address-postal"
              ...
              <Field label="Country" htmlFor="address-country" error={submitted ? validationErrors.country : null} required>
                <Input
                  id="address-country"
                  value={form.country}
            ...
            <Field label="Phone number" htmlFor="address-phone" error={submitted ? validationErrors.phone_number : null}>
              <Input
                id="address-phone"

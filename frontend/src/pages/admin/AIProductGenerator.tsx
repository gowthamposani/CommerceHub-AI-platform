...
function toPayload(values: GeneratorFormValues): AIProductDescriptionRequest {
  return {
    ...
    features: values.features
      ...
      .filter(Boolean),
    specifications: values.specifications.reduce<Record<string, string>>(
      (specifications, item) => {
            ...
            >
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <label className="block sm:col-span-2">
                  ...
                  />
                  {errors.productName ? (
                    <p className="mt-1 text-sm text-rose-600">{errors.productName.message}</p>
                  ) : null}
                </label>
                ...
                <label className="block">
                  ...
                  />
                  {errors.brand ? (
                    <p className="mt-1 text-sm text-rose-600">{errors.brand.message}</p>
                  ) : null}
                </label>
